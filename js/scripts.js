...
(function($) {
    ...
    $('#experience-timeline').each(function() {
        ...
        $($this.find('.vtimeline-point')[0]).prepend('<div class="vtimeline-icon"><a href="https://tritonse.github.io/" taget="blank"><img src="./images/tse.png" alt="Avatar" style="margin: 5%; width: 88%; height: 88%; border-radius: 50%"></div>');
        $($this.find('.vtimeline-point')[1]).prepend('<div class="vtimeline-icon"><a href="https://www.omni.sc/" target="blank"><img src="./images/Omniscience.png" alt="Avatar" style="margin: 5%; width: 88%; height: 88%; border-radius:50%"></div>');
        $($this.find('.vtimeline-point')[2]).prepend('<div class="vtimeline-icon"><a href="https://voyagerspacetech.com/" target="blank"><img src="./images/Voyager.png" alt="Avatar" style="margin: 5%; width: 88%; height: 88%; border-radius:50%"></div>');
        $($this.find('.vtimeline-point')[3]).prepend('<div class="vtimeline-icon"><a href="http://www.cn1win.com/index.html" taget="blank"><img src="./images/cn1win.png" alt="Avatar" style="margin: 5%; width: 88%; height: 88%; border-radius: 50%"></div>');
