...
(function($) {
   ...
   // $('.panel').height = $('#skills').height + $('body').max
    ...
    $('#experience-timeline').each(function() {
        ...
        $($this.find('.vtimeline-point')[0]).prepend('<div class="vtimeline-icon"><a href="https://tripactions.com/" taget="blank"><img src="./images/tripactions-squarelogo.png" alt="Avatar" style="margin: 5%; width: 88%; border-radius: 50%"></div>');
        ...
        $($this.find('.vtimeline-point')[2]).prepend('<div class="vtimeline-icon"><a href="https://www.omni.sc/" target="blank"><img src="./images/Omniscience.png" alt="Avatar" style="margin: 5%; width: 88%; border-radius:50%"></div>');
        $($this.find('.vtimeline-point')[3]).prepend('<div class="vtimeline-icon"><a href="https://voyagerspacetech.com/" target="blank"><img src="./images/Voyager.png" alt="Avatar" style="margin: 5%; width: 88%; border-radius:50%"></div>');
